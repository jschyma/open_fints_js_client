  ...
  */
  me.MsgGetKontoUmsaetze = function (konto, from_date, to_date, cb) {
    if(cb || typeof Promise !== 'function')
      ...
      return new Promise(function(resolve, reject) {
        MsgGetKontoUmsaetze(konto, from_date, to_date, function (error, rMsg, data) {
          if(error)
            reject(error)
          else
            resolve({'rMsg': rMsg, 'data': data})
        })
      })
  }
      ...
      return new Promise(function (resolve, reject) {
        MsgGetSaldo(konto, function (error, recvMsg, saldo) {
          if(error)
            ...
            resolve({'recvMsg': recvMsg, 'saldo': saldo})
        })
      })
  }

  MsgGetSaldo = function (konto, cb) {
